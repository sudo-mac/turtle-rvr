...
class DriveControlObserver:
    ...
    def __init__(self, rvr):
        ...
        self.__led_control = LedControlObserver(
            self.__rvr
        )  # TODO: eventually call self.__rvr.led_control
    ...
    def drive_backward_seconds(self, speed=0, heading=0, time_to_drive=1):
        ...
        """
        self.__timed_drive(
            speed, heading, DriveControlObserver.__drive_reverse_flag, time_to_drive
        )
    ...
    def drive_forward_seconds(self, speed=0, heading=0, time_to_drive=1):
        ...
        self.__timed_drive(
            speed, heading, DriveControlObserver.__drive_no_flag, time_to_drive
        )
    ...
    def turn_left_degrees(self, heading, amount=90):
        ...
        """
        self.__rvr.drive_with_heading(
            0, (heading - amount) % 360, DriveControlObserver.__drive_no_flag
        )
        time.sleep(0.5)
